const contentLetterSrart_actived = "Hôm nay sinh nhật bạn,Tớ chẳng có quà đâu,Chỉ có tấm thiệp màu,Làm quà thay lời chúc." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc cậu sinh nhật tràn ngập niềm vui và sự yêu thương! Sinh nhật vui vẻ nhé!" //Nội dung của bức thư

// Gắn 1 đường link ảnh bất kì
let imgStart = document.querySelector(".myAI"); //Hình ảnh xuất hiện trong lời mở đầu của bức thư
imgStart.src = "./img/anh uyen lanh.jpg";

// Gắn 1 link ảnh bất kì
let imgLetter = document.querySelector(".img");
imgLetter.src = "./img/uyenlanh2.jpg"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
